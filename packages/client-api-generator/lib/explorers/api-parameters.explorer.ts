...
const exploreApiReflectedParametersMetadata = (instance, prototype, method) => {
    ...
    const parametersMetadata = Reflect.getMetadata(ROUTE_ARGS_METADATA, instance.constructor, method.name) || {};
    ...
    const parameters = mapValues(parametersWithType, (val, key) => ({
        ...val,
